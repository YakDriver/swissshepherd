...
func TestArgumentsSectionRule_Complete(t *testing.T) {
	t.Parallel()
...
func TestArgumentsSectionRule_Incomplete(t *testing.T) {
	t.Parallel()
...
func TestArgumentsSectionRule_SkipsImplicit(t *testing.T) {
	t.Parallel()
